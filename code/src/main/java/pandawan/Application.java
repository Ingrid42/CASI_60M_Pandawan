...
public class Application {
	...
	public static void main(String[] args) {
		...
		if(true){
			...
			Utilisateur user2 = utilisateurRepository.save(new Utilisateur("test2","test2@test.test", "NomTest", "PrenomTest", new BCryptPasswordEncoder().encode("test"), new ArrayList<Role>()));
		}
